...
VALUES ('Renaul Clio', 'Renault', 12000, 13),
       ...
       ('Ferrari Tributo','Ferrari',27500,12);
# GRUPOS
...
VALUES (1,NULL,'Jesus David','Posada Escobar','Responsable de Tienda',CURDATE(),185000,4),
       ...
       (2,3,'Victor Manuel','Sambrano Arenas','Ayudante en Tienda',CURDATE(),55000,6), 
       ...
       (6,8,'Saulo','De Tarso','Ayudante en Tienda',CURDATE(),10000,10);
